...
namespace BS_Clinic
{
    public partial class QuickAnalysis : System.Web.UI.Page
    {
        ...
        {
            if(age.Text == "" || weight.Text == "" || suger.Text == "")
            {
                input.Controls.Add(new LiteralControl("<br /><br /><div class=\"col-12\"><div class=\"alert alert-warning text-center alert-dismissible fade show\" role=\"alert\">يرجى ملئ كافة الحقول<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button></div></div>"));
                return;
            }
            ...
            int[] k = new int[3] { Int32.Parse(suger.Text), Int32.Parse(weight.Text), Int32.Parse(age.Text) };
            if (Int32.Parse(suger.Text) < 60)
            {
