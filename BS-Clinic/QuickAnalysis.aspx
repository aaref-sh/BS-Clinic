<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuickAnalysis.aspx.cs" Inherits="BS_Clinic.QuickAnalysis" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <section class="doctor_part section_padding single_doctor_part" dir="rtl">
            <div class="container">
                <div class="row" id="input" runat="server">
                    <div class="col-4"><asp:TextBox ID="age" runat="server" CssClass="form-control" placeholder="العمر"></asp:TextBox></div>
                    <div class="col-4"><asp:TextBox ID="weight" runat="server" CssClass="form-control" placeholder="الوزن"></asp:TextBox></div>
                    <div class="col-4"><asp:TextBox ID="suger" runat="server" CssClass="form-control" placeholder="نسبة السكر"></asp:TextBox></div>
                    <br />
                    <br />
                    <div class="col-12"><asp:LinkButton ID="analysis" runat="server" Width="100%" CssClass="btn btn-success" OnClick="analysis_Click">تحليل</asp:LinkButton></div>
                </div>
                <div runat="server" id="stat" style="background-image: url(./img/report.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;">
